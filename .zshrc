...
ZSH_CUSTOM=~/env/custom-oh-my-zsh
...
plugins=(git zsh-autosuggestions zsh-syntax-highlighting web-search direnv kubectl)
...
# Find MP we are currently in
if [[ -f product-spec.json ]]; then
    HISTFILE="${HOME}/.zsh_histories/${$(pwd)//\//_}.zsh_history"
fi

# Created by `pipx` on 2025-09-02 16:42:47
export PATH="$PATH:/Users/tkistler/.local/bin"
